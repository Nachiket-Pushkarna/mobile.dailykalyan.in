  ...
  return (
    <div className="bg-gray-800 p-4 sm:p-6 rounded-lg shadow-lg">
      <div className="border p-4 text-center mb-4 bg-gray-900 rounded-lg">
        <div className="text-orange-500 text-lg sm:text-xl font-bold">Available Amount</div>
        <div className="text-white text-md sm:text-lg">{walletDetails?.wallet_amt}</div>
      </div>
      <div className="flex flex-col sm:flex-row justify-between mb-4">
        <div className="text-white text-sm sm:text-base mb-2 sm:mb-0">
      ...
      <div className="flex justify-center mt-4">
        <button
          className="py-2 sm:py-3 bg-orange-500 text-white font-bold rounded-lg w-full"
